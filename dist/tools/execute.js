...
exports.executionTools = void 0;
exports.executionTools = [
    {
    ...
    },
    {
        ...
        handler: async (client, args) => {
            ...
            if (args.schema_id)
                params.set('schema_id', args.schema_id);
            if (args.status)
            ...
            const lines = executions.map((e) => `- **${e.id.substring(0, 16)}...** | ${e.status} | ${e.schema_id} | ${e.provider} | ${e.latency_ms}ms | ${new Date(e.created_at).toLocaleString()}`);
